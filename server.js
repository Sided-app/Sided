...
const COMP_MAP = { 'Premier League':'PL','La Liga':'PD','Bundesliga':'BL1','Serie A':'SA','Ligue 1':'FL1','Eredivisie':'DED','Champions League':'CL','Europa League':'EL','Conference League':'ECLC','Brasileirão':'BSA','Championship':'ELC' };
...
const AF_LEAGUES = { 'World Cup 2026': 1, 'Liga Argentina': 128, 'MLS': 253 };
...
app.post('/api/profile', auth, async (req, res) => {
  ...
  const avatar = Math.max(0, Math.min(54, parseInt(req.body.avatar) || 10));
